...
$(document).ready(function() {
  ...
  $("#confirm-text").on("click", function() {
    swal({
      title: "Confirmer",
      text: "Voulez-vous confirmer votre paiement",
      icon: "warning",
      buttons: {
        cancel: {
          text: "Non, annuler s.v.p!",
          value: null,
          visible: true,
          className: "",
          closeModal: false
      ...
      if (isConfirm) {
        swal("Payé!", "le paiement a été effectué!!", "success");
      } else {
        swal("Annuler", "le paiement a été annulé.", "error");
      }
    });
  });
