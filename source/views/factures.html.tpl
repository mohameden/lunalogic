...
<head>
  ...
  <title>MAROC Telecom - Factures</title>
  ...
  <link rel="stylesheet" type="text/css" href="assets/app-assets/vendors/css/tables/jsgrid/jsgrid-theme.min.css">
  <link rel="stylesheet" type="text/css" href="assets/app-assets/vendors/css/tables/jsgrid/jsgrid.min.css">
  <!-- END VENDOR CSS-->
  <!-- BEGIN STACK CSS-->
        ...
        <ul class="nav navbar-nav flex-row">
          ...
          <li class="nav-item">
            <a class="navbar-brand" href="index.html">
              <img style="width: 209px; height: 45px; margin-bottom: 20px;margin-top: -9px;" alt="stack admin logo" src="assets/app-assets/images/logo/logo-maroctelecom.png">
            </a>
          </li>
  ...
  <div class="main-menu menu-fixed menu-light menu-accordion" data-scroll-to-active="true">
    <div class="main-menu-content">
      <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
        ...
        <li class=" nav-item"><a href="index.html"><i class="ft-home"></i><span class="menu-title" data-i18n="">Tableau Generale</span><span class="badge badge badge-primary badge-pill float-right mr-2">3</span></a>

        </li>
        <li class=" navigation-header">
          <span>Applicqtions</span><i class=" ft-minus" data-toggle="tooltip" data-placement="right"
          data-original-title="Apps"></i>
        </li>
        <li class=" nav-item"><a href="#"><i class="ft-mail"></i><span class="menu-title" data-i18n="">Factures</span></a>
        </li>
        ...
        <div class="content-header-right breadcrumbs-right breadcrumbs-top col-md-6 col-12">
          <div class="breadcrumb-wrapper col-12">
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active">Internet
              </li>
            </ol>
          </div>
        </div>
            ...
            <div class="col-12">
              <div class="card">
                <div class="card-header">
                  <h4 class="card-title">Listing Factures</h4>
                  ...
                  <div class="card-body card-dashboard">
                    <table class="table table-striped table-bordered zero-configuration">
                      ...
                      <tbody>
                        <tr>
                          <td>11/03/2018</td>
                          <td>Facture Abonnement Intenent Mois de Mars</td>
                          <td>24/03/2018</td>
                          <td><button type="button" class="btn btn-light btn-min-width mr-1 mb-1"><i class="fa fa-money"></i> Payé </button></td>
                        </tr>
                        <tr>
                          <td>11/04/2018</td>
                          <td>Facture Abonnement Intenent Mois de Avril</td>
                          <td>24/04/2018</td>
                          <td><button type="button" class="btn btn-light btn-min-width mr-1 mb-1"><i class="fa fa-money"></i> Payé </button></td>
                        </tr>
                        <tr>
