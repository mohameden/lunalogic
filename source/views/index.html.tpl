...
<head>
  ...
  <title>Maroc Telecom - Dashboard Admin</title>
  <link rel="apple-touch-icon" href="views/app-assets/images/ico/apple-icon-120.png">
  ...
  <link rel="stylesheet" type="text/css" href="assets/app-assets/css/core/colors/palette-climacon.css">
  ...
  <link rel="stylesheet" type="text/css" href="assets/app-assets/css/pages/users.css">
  <!-- END Page Level CSS-->
  <!-- BEGIN Custom CSS-->
...
data-open="click" data-menu="vertical-menu" data-col="2-columns">
        ...
        <ul class="nav navbar-nav flex-row">
          ...
          <li class="nav-item">
            <a class="navbar-brand" href="index.html">
              <img class="brand-logo" alt="stack admin logo" src="assets/app-assets/images/logo/stack-logo.png">
              <h2 class="brand-text">MAROC TELECOM</h2>
            </a>
          </li>
        ...
        <div class="collapse navbar-collapse" id="navbar-mobile">
              ...
              <ul class="mega-dropdown-menu dropdown-menu row">
                <li class="col-md-2">
                  ...
                  <div id="mega-menu-carousel-example">
                    <div>
                      <img class="rounded img-fluid mb-1" src="assets/app-assets/images/slider/slider-2.png"
          ...
          <ul class="nav navbar-nav float-right">
            <li class="dropdown dropdown-language nav-item"><a class="dropdown-toggle nav-link" id="dropdown-flag" href="#" data-toggle="dropdown"
              ...
              <div class="dropdown-menu" aria-labelledby="dropdown-flag"><a class="dropdown-item" href="#"><i class="flag-icon flag-icon-fr"></i>  French</a>
                ...
                <li class="scrollable-container media-list">
                    ...
                    <div class="media">
                      <div class="media-left">
                        <span class="avatar avatar-sm avatar-online rounded-circle">
                          <img src="assets/app-assets/images/portrait/small/avatar-s-1.png" alt="avatar"><i></i></span>
                      </div>
                      <div class="media-body">
                    ...
                    <div class="media">
                      <div class="media-left">
                        <span class="avatar avatar-sm avatar-busy rounded-circle">
                          <img src="assets/app-assets/images/portrait/small/avatar-s-2.png" alt="avatar"><i></i></span>
                      </div>
                      <div class="media-body">
                  ...
                  <a href="javascript:void(0)">
                    <div class="media">
                      <div class="media-left">
                        <span class="avatar avatar-sm avatar-online rounded-circle">
                          <img src="assets/app-assets/images/portrait/small/avatar-s-3.png" alt="avatar"><i></i></span>
                      </div>
                      <div class="media-body">
                    ...
                    <div class="media">
                      <div class="media-left">
                        <span class="avatar avatar-sm avatar-away rounded-circle">
                          <img src="assets/app-assets/images/portrait/small/avatar-s-6.png" alt="avatar"><i></i></span>
                      </div>
                      <div class="media-body">
    ...
    <div class="main-menu-content">
      <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
        <li class=" navigation-header">
          <span>Générale</span><i class=" ft-minus" data-toggle="tooltip" data-placement="right"
          data-original-title="General"></i>
        </li>
        <li class=" nav-item"><a href="index.html"><i class="ft-home"></i><span class="menu-title" data-i18n="">Tableau de board</span></a>
        </li>
        <li class=" navigation-header">
          <span>Applications</span><i class=" ft-minus" data-toggle="tooltip" data-placement="right"
          data-original-title="Apps"></i>
        </li>
        <li class=" nav-item"><a href="invoice-template.html"><i class="ft-printer"></i><span class="menu-title" data-i18n="">Factures</span></a>
        </li>
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-12 border-right-blue-grey border-right-lighten-5 clearfix">
                      <div class="media">
                        <div class="media-left pr-1">
                          <img class="media-object img-xl" src="app-assets/images/portrait/small/avatar-s-5.png"
            ...
            <div class="card">
              ...
              <div class="card-content">
                <div id="friends-activity" class="media-list height-400 position-relative">
                  ...
                  <a href="#" class="media border-0">
                    <div class="media-left pr-1">
                      <img class="media-object avatar avatar-sm rounded-circle" src="assets/app-assets/images/portrait/small/avatar-s-8.png"
                      alt="Generic placeholder image">
                    </div>
                    <div class="media-body w-100">
                  ...
                  <a href="#" class="media border-0">
                    <div class="media-left pr-1">
                      <img class="media-object avatar avatar-sm rounded-circle" src="assets/app-assets/images/portrait/small/avatar-s-9.png"
                      alt="Generic placeholder image">
                    </div>
                    <div class="media-body w-100">
                  ...
                  <a href="#" class="media border-0">
                    <div class="media-left pr-1">
                      <img class="media-object avatar avatar-sm rounded-circle" src="assets/app-assets/images/portrait/small/avatar-s-10.png"
                      alt="Generic placeholder image">
                    </div>
                    <div class="media-body w-100">
                  ...
                  <a href="#" class="media border-0">
                    <div class="media-left pr-1">
                      <img class="media-object avatar avatar-sm rounded-circle" src="assets/app-assets/images/portrait/small/avatar-s-11.png"
                      alt="Generic placeholder image">
                    </div>
                    <div class="media-body w-100">
                  ...
                  <a href="#" class="media border-0">
                    <div class="media-left pr-1">
                      <img class="media-object avatar avatar-sm rounded-circle" src="assets/app-assets/images/portrait/small/avatar-s-12.png"
                      alt="Generic placeholder image">
                    </div>
                    <div class="media-body w-100">
                    ...
                    <div id="carousel-example" class="carousel slide" data-ride="carousel">
                      ...
                      <div class="carousel-inner" role="listbox">
                        <div class="carousel-item active">
                          <img src="assets/app-assets/images/pages/fitness-slide-1.jpg" class="img-fluid"
                          alt="First slide">
                        </div>
                        <div class="carousel-item">
                          <img src="assets/app-assets/images/pages/fitness-slide-2.jpg" class="img-fluid"
                          alt="Second slide">
                        </div>
                        <div class="carousel-item">
                          <img src="assets/app-assets/images/pages/fitness-slide-3.jpg" class="img-fluid"
                          alt="Third slide">
                        </div>
                      </div>
                ...
                <div class="card profile-card-with-cover">
                  <div class="card-content">
                    ...
                    <div class="card-profile-image">
                      <img src="assets/app-assets/images/portrait/small/avatar-s-8.png" class="rounded-circle img-border box-shadow-1"
                      alt="Card image">
                    </div>
  ...
  <footer class="footer footer-static footer-light navbar-border">
    <p class="clearfix blue-grey lighten-2 text-sm-center mb-0 px-2">
      <span class="float-md-left d-block d-md-inline-block">Copyright &copy; 2018 <a class="text-bold-800 grey darken-2" href="https://themeforest.net/user/pixinvent/portfolio?ref=pixinvent"
        target="_blank">Lunalogic </a>, All rights reserved. </span>
  ...
  <script src="assets/app-assets/vendors/js/charts/gmaps.min.js" type="text/javascript"></script>
  <script src="assets/app-assets/vendors/js/forms/icheck/icheck.min.js" type="text/javascript"></script>
  <script src="assets/app-assets/vendors/js/extensions/jquery.knob.min.js" type="text/javascript"></script>
  <script src="assets/app-assets/vendors/js/charts/raphael-min.js" type="text/javascript"></script>
  <script src="assets/app-assets/vendors/js/charts/morris.min.js" type="text/javascript"></script>
  <script src="assets/app-assets/vendors/js/charts/jquery.sparkline.min.js" type="text/javascript"></script>
  <script src="assets/app-assets/vendors/js/extensions/unslider-min.js" type="text/javascript"></script>
  <script src="assets/app-assets/vendors/js/charts/echarts/echarts.js" type="text/javascript"></script>
  <!-- END PAGE VENDOR JS-->
  <!-- BEGIN STACK JS-->
  ...
  <!-- END STACK JS-->
  <!-- BEGIN PAGE LEVEL JS-->
  <script src="assets/app-assets/js/scripts/pages/dashboard-fitness.js" type="text/javascript"></script>
  <!-- END PAGE LEVEL JS-->
</body>
</html>
